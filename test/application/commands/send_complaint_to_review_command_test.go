...
func TestSendComplaintToReviewCommand_Setup(t *testing.T) {
...
func TestSendComplaintToReviewCommand_Execute(t *testing.T) {
	TestSendComplaintToReviewCommand_Setup(t)
	ctx := context.Background()
	reg := repositories.MapperRegistryInstance()
	userRepository, ok := reg.Get("User").(repositories.UserRepository)
	assert.True(t, ok)
