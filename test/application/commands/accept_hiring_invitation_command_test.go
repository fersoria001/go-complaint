...
func TestAcceptHiringInvitationCommand_Setup(t *testing.T) {
...
func TestAcceptHiringInvitationCommand_Execute(t *testing.T) {
	TestAcceptHiringInvitationCommand_Setup(t)
	ctx := context.Background()
