...
export type FindComplaintWriting = {
  authorId: Scalars['String']['input'];
  receiverId: Scalars['String']['input'];
};
...
export type Mutation = {
  ...
  contactEmail: Scalars['Boolean']['output'];
...
export type MutationContactEmailArgs = {
  input: ContactEmail;
};
...
export type Query = {
  ...
  complaintWritingByAuthorIdAndReceiverId: Complaint;
...
export type QueryComplaintWritingByAuthorIdAndReceiverIdArgs = {
...
export type RecoverPasswordMutationMutationVariables = Exact<{
  userName: Scalars['String']['input'];
}>;


export type RecoverPasswordMutationMutation = { __typename?: 'Mutation', recoverPassword: boolean };
...
export type SendContactEmailMutationMutationVariables = Exact<{
  input: ContactEmail;
}>;


export type SendContactEmailMutationMutation = { __typename?: 'Mutation', contactEmail: boolean };
...
export type ComplaintWritingByAuthorIdAndReceiverIdQueryQueryVariables = Exact<{
  input: FindComplaintWriting;
}>;


export type ComplaintWritingByAuthorIdAndReceiverIdQueryQuery = { __typename?: 'Query', complaintWritingByAuthorIdAndReceiverId: { __typename?: 'Complaint', id?: string | null } };
...
export const RecoverPasswordMutationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"recoverPasswordMutation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"userName"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"recoverPassword"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"userName"},"value":{"kind":"Variable","name":{"kind":"Name","value":"userName"}}}]}]}}]} as unknown as DocumentNode<RecoverPasswordMutationMutation, RecoverPasswordMutationMutationVariables>;
...
export const SendContactEmailMutationDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"sendContactEmailMutation"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"ContactEmail"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"contactEmail"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}]}]}}]} as unknown as DocumentNode<SendContactEmailMutationMutation, SendContactEmailMutationMutationVariables>;
...
export const ComplaintWritingByAuthorIdAndReceiverIdQueryDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"query","name":{"kind":"Name","value":"complaintWritingByAuthorIdAndReceiverIdQuery"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"input"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"FindComplaintWriting"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"complaintWritingByAuthorIdAndReceiverId"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"input"},"value":{"kind":"Variable","name":{"kind":"Name","value":"input"}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}}]}}]}}]} as unknown as DocumentNode<ComplaintWritingByAuthorIdAndReceiverIdQueryQuery, ComplaintWritingByAuthorIdAndReceiverIdQueryQueryVariables>;
