...
import { ChangeEnterpriseAddress, Country, Enterprise, UpdateUserAddress, UserDescriptor } from "@/gql/graphql"
...
import { changeEnterpriseAddress } from "@/lib/actions/graphqlActions"
...
const UpdateAddress: React.FC<Props> = ({ enterprise, countries }: Props) => {
    ...
    const updateMutation = useMutation({
        mutationFn: async ({ newCountryId, newCountyId, newCityId }: Omit<ChangeEnterpriseAddress, "enterpriseId">) => {
            await changeEnterpriseAddress({
