...
import UserNotificationsLog from "./components/profile/UserNotificationsLog";
...
function ProfileLayout() {
    ...
    if (!user || !notifications) return <div>loading...</div>;
    ...
    return (
        <ComplaintContextProvider>
                ...
                <div className="px-3 py-3 lg:px-5 lg:pl-3">
                    <div className="flex items-center justify-between">
                        ...
                        <div className="flex items-center">
                            {
                                user && <UserNotificationsLog notifications={notifications} />
                            }
            ...
            <aside id="logo-sidebar"
                className={
                    sideBarOpen ?
                        `fixed top-0 left-0 z-40 w-64 h-screen pt-20 transition-transform -translate-x-full
             ...
             bg-white border-r border-gray-200 sm:translate-x-0`
                ...
                <div className="h-full px-3 pb-4 overflow-y-auto bg-white ">
                    <ul className="space-y-2 font-medium">
                        <li>
                            <Link to="/profile" className="flex items-center p-2 text-gray-900 rounded-lg
                        ...
                        <li>
                            <Link to="/profile/register-enterprise" className="flex items-center p-2 text-gray-900 rounded-lg
                             hover:bg-gray-100 group">
                                <svg className="w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900"
                                    aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
                                    <path d="M16.975 11H10V4.025a1 1 0 0 0-1.066-.998 8.5 8.5 0 1 0 9.039 9.039.999.999 0 0 0-1-1.066h.002Z" />
                                ...
                                <span className="ms-3">Register an Enterprise </span>
                            </Link>
                        </li>
                        <li>
                            <Link to="/profile/complaint" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                                ...
                                <span className="flex-1 ms-3 whitespace-nowrap">Send a Complaint</span>
                                <span className="inline-flex items-center justify-center px-2 ms-3 text-sm font-medium text-gray-800 bg-gray-100 rounded-full dark:bg-gray-700 dark:text-gray-300">Pro</span>
                            </Link>
                        </li>
                        <li>
                            <Link to="/profile/inbox" className="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100  group">
                        ...
                        <li>
                            <Link to="/profile/sent" className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                        ...
                        <li>
                            <Link to={"/profile/reviews"} className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                                <svg className="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75  group-hover:text-gray-900 " aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 20 18">
                                    <path d="M14 2a3.963 3.963 0 0 0-1.4.267 6.439 6.439 0 0 1-1.331 6.638A4 4 0 1 0 14 2Zm1 9h-1.264A6.957 6.957 0 0 1 15 15v2a2.97 2.97 0 0 1-.184 1H19a1 1 0 0 0 1-1v-1a5.006 5.006 0 0 0-5-5ZM6.5 9a4.5 4.5 0 1 0 0-9 4.5 4.5 0 0 0 0 9ZM8 10H5a5.006 5.006 0 0 0-5 5v2a1 1 0 0 0 1 1h11a1 1 0 0 0 1-1v-2a5.006 5.006 0 0 0-5-5Z" />
                                </svg>
