...
function ChatInput({ callback }: Props) {
    ...
    return (
        <form className="relative" >
            ...
            <div className="flex flex-col md:flex-row items-center  md:px-3 md:py-2 rounded-lg bg-gray-50">
                <div className="flex self-start my-auto ">
                    ...
                    type="button" className="p-2 text-gray-500 rounded-lg cursor-pointer hover:text-gray-900 hover:bg-gray-100">
             ...
             focus:ring-blue-500 focus:border-blue-500 resize-none" placeholder="Your message...">
                    ...
                    <button onMouseUp={handleClick} id="submit-btn" type="button" className="my-auto inline-flex justify-center p-2 text-blue-600 rounded-full cursor-pointer hover:bg-blue-100">
