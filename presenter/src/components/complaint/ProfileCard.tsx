...
function ProfileCard({ userFullName, sub, profileIMG }: ProfileCardProps) {
    const menu = false;
    const actions = false;
    return (<div
        ...
        {menu &&
          ...
          focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg text-sm p-1.5"
                ...
                <div
                    id="dropdown"
                    className="z-10 hidden text-base list-none bg-white 
        ...
        <div
            ...
            text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800
