...
import { Route } from "../../../routes/$enterpriseID/history";
                    ...
                    <tbody >
                        {sent && sent.complaints.map((complaint: ComplaintType) => {
                            return (<tr key={complaint.id} className="bg-white border-b hover:bg-gray-50">
                                ...
                                <th scope="row" >
                                    <Link to={`/${enterpriseID}/history/${complaint.id}`} className="flex align-center  whitespace-nowrap px-6 py-4">
