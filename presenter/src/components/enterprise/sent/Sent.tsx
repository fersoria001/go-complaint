...
import { Route } from "../../../routes/$enterpriseID/sent";
                    ...
                    <tbody >
                        {sent && sent.complaints.map((complaint: ComplaintType) => {
                            return (<tr key={complaint.id} className="bg-white border-b hover:bg-gray-50">
                                ...
                                <th scope="row" >
                                    <Link to={`/${enterpriseID}/sent/${complaint.id}`} className="flex align-center  whitespace-nowrap px-6 py-4">
                                        <img className="w-10 h-10 rounded-full" src={complaint.receiverProfileIMG} alt="avatar" />
                                        <div className="ps-3 text-center my-auto font-medium text-gray-900" >
                                            {complaint.receiverFullName}
                                        </div>
                                    </Link>
                                </th>
