...
export const UpdateAddress: React.FC<Props> = ({ enterpriseID, countries }: Props) => {
    ...
    const handleUpdate = async () => {
        ...
        return await updateAddress(enterpriseID, selectedCountry, selectedCounty, selectedCity)
    }
    const handleCleanUp = () => {
        setReset(false)
    }
