...
function EnterpriseLayout() {
    ...
    if (!enterprise || !notifications) return <div>loading...</div>;
                                ...
                                <div>
                                    <button
                                        ...
                                        <img className="w-8 h-8 rounded-full"
                                            src={
                                                enterprise.logoIMG === "default.jpg" ?
                                                    "/default.jpg" : enterprise.logoIMG
                                            } alt="user photo" />
                                    </button>
                                </div>
                                <div className={
             ...
             bg-white border-r border-gray-200 sm:translate-x-0`
                ...
                <p className="text-gray-900 text-center underline underline-offset-8 pb-5 "> {enterprise.name} </p>
                    <ul className="space-y-2 font-medium">
                        ...
                        <li>
                            <Link to={`/enterprises/${enterprise.name}/hiring`} className="flex items-center p-2 text-gray-900 rounded-lg
                             hover:bg-gray-100 group">
                                <svg className="w-5 h-5 text-gray-500 transition duration-75 group-hover:text-gray-900"
                                    aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 21">
                                    <path d="M16.975 11H10V4.025a1 1 0 0 0-1.066-.998 8.5 8.5 0 1 0 9.039 9.039.999.999 0 0 0-1-1.066h.002Z" />
                                ...
                                <span className="ms-3">Hiring</span>
                            </Link>
                        </li>
                        <li>
                        ...
                        <li>
                            <Link to={`/enterprises/${enterprise.name}/complaint`} className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
                        ...
                        <li>
                            <Link to={`/enterprises/${enterprise.name}/inbox`} className="flex items-center p-2 text-gray-900 rounded-lg  hover:bg-gray-100  group">
                        ...
                        <li>
                            <Link to={`/enterprises/${enterprise.name}/sent`} className="flex items-center p-2 text-gray-900 rounded-lg hover:bg-gray-100 group">
